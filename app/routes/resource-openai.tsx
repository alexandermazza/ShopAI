  ...
  try {
    ...
    if (operation === 'getSuggestedQuestions') {
      ...
      const completion = await openai.chat.completions.create({
        ...
        messages: [{ 
          role: "user", 
          content: `Please analyze the following product information and generate exactly three distinct, relevant questions that a potential customer might ask about it. Respond only with a JSON array of strings, where each string is a question. Ensure the questions are in ${languageName}.
